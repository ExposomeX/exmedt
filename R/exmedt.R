...
#' @usage LoadMedt(PID = PID, UseExample = "default", DataPath = NULL, VocaPath = NULL)
...
#'    and mediator.
#' @usage Pairwise(PID, OutPath, VarsY, VarsX = "default", VarsM = "default",
#'     VarsC = "default", Family, Iter = 500)
#' @param PID chr. Program ID. It must be the same with the PID generated
#'    by InitMedt.
...
#'    prior to using it.
#' @usage VizMedtPair(PID, OutPath, Brightness = "light", Pallette = "default1")
#' @param PID chr. Program ID. It must be the same with the PID generated
#'    by InitMedt.
#' @param OutPath chr. Output file directory, e.g. "D:/output". If "default",
#'    the current working directory will be set.It should be noted that the
...
#' @usage RedX(PID, OutPath, VarsY, VarsC = "default", VarsM = "default",
#'     Method = "mean", Folds = 10, Family, Iter = 500)
#' @param PID chr. Program ID. It must be the same with the PID generated
#'    by InitMedt.
#' @param OutPath chr. Output file directory, e.g. "D:/output". If "default",
#'    the current working directory will be set.It should be noted that the
...
#' @usage RedM(PID, OutPath, VarsY, VarsX = "default", VarsC = "default",
#'     Method = "mean", Family, Iter = 500)
#' @param PID chr. Program ID. It must be the same with the PID generated
#'    by InitMedt.
#' @param OutPath chr. Output file directory, e.g. "D:/output". If "default",
#'    the current working directory will be set.It should be noted that the
...
#' @usage RedXM(PID, OutPath, VarsY, VarsC = "default", Method = "mean", 
#'     Family, Iter = 500)
#' @param PID chr. Program ID. It must be the same with the PID generated
#'    by InitMedt.
#' @param OutPath chr. Output file directory, e.g. "D:/output". If "default",
...
#'    prior to using it.
#' @usage VizRedXM(PID, OutPath, Brightness = "light", Pallette = "default1")
#' @param PID chr. Program ID. It must be the same with the PID generated
#'    by InitMedt.
#' @param OutPath chr. Output file directory, e.g. "D:/output". If "default",
#'    the current working directory will be set.It should be noted that the
...
#' @usage ImptM(PID, OutPath, VarsY, VarsX = "default", VarsC = "default")
#' @param PID chr. Program ID. It must be the same with the PID generated
#'    by InitMedt.
#' @param OutPath chr. Output file directory, e.g. "D:/output". If "default",
#'    the current working directory will be set.It should be noted that the
